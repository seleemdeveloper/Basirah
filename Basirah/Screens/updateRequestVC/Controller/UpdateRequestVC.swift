...
class UpdateRequestVC: UIViewController {
    ...
    @IBAction func submitButtonDidTouched(_ sender: UIButton)
    {
        ...
        if valid
        {
            updateRequest(request: request,bookName:  bookNameTextField.text ?? "", bookAuthor: authorNameTextField.text ?? "", category: categoryTextField.text ?? "", dueDate: dueDateTextField.text ?? "", {
    ...
    @IBAction func deleteRequestButtonDidTouched(_ sender: UIButton)
    {
